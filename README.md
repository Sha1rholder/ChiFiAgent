...
**Alipay** is the preferred payment method **for Asian customers** in Indonesia, Malaysia, Thailand, Singapore, South Korea (partial), Philippines (partial), and Vietnam (partial). Cross-border payment fees depend on the amount and your location (usually minimal). You can ask Agent for a payment QR code or provide your Alipay account (phone number with country code) to receive a payment request.

Pay via Alipay: scan [my Alipay QR code.](<./assets/Alipay QR code.jpg>) My legal full name is `张君一`, so if Alipay asks for my "middle name", please enter `君`.

## VISA

If you pay with a **VISA card**, you'll be paying service fee, and the exact rate varies by institution. Transfers usually take about one business day.
...
The declared value **may** affect customs duties. A higher declared value could lead to higher taxes, while a lower one might increase the chance of customs inspection. If you're unsure, Agent can recommend a suitable declared value. **Agent will help you minimize or avoid customs costs. To date, no customer was charged any customs duties.**
...
| Feb 6, 2026   | Code | 1 XXX ≈? CNY | 1 CNY ≈? XXX |
| ------------- | ---- | ------------ | ------------ |
| US dollar     | USD  | ≈6.94 CNY    | ≈0.14 USD    |
| Euro          | EUR  | ≈8.18 CNY    | ≈0.12 EUR    |
| British pound | GBP  | ≈9.40 CNY    | ≈0.11 GBP    |
| Japanese yen  | JPY  | ≈0.04 CNY    | ≈23 JPY      |
